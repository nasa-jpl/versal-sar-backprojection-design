# Run this with the following commnad: 'vitis-run --tcl run_dma_stride_controller_tb.tcl'

# Create a project
open_project -reset dma_stride_controller_testbench

# Change working directory to where this tcl script is located
set script_dir [file dirname [info script]]

# Add design files
add_files $script_dir/../dma_stride_controller.cpp
