...
// TODO: dma_stride_controller currently only works with one AIE switch due to
// using an array type as function signature. This is strange since this is
// perfectly fine when running the testbench, but the system.cfg file can't
// seem to reconcile how to interpret the array
