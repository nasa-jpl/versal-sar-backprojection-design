...
\begin{figure}[!htb]
  ...
  \begin{subfigure}{0.48\linewidth}
    ...
    \caption{MATLAB generated image of 424x42207 resolution over 360° synthetic
    aperture (\texttt{FileNum = 360}, \texttt{data.Nfft = 424}).}
  ...
  \begin{subfigure}{0.48\linewidth}
    ...
    \caption{MATLAB generated image of 425x571 resolution over 5° synthetic
...
%dlmwrite("gotcha_slowtime_pass1_360deg_HH.csv", [data.AntX', data.AntY', data.AntZ', data.R0'], 'delimiter', ',', 'precision', 12)
