...
% =============================================================================
\subsection{Test \#1: 425×602, 5.1° Az Coverage, \textit{main} branch}
% =============================================================================
...
\begin{table}[hbt]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    \midrule
    \textbf{Scene coverage} & 101.88 m (range) × 108.41 m (cross-range) \\
    \textbf{Image resolution} & 0.24 m (range) × 0.18 m (cross-range) \\
    \textbf{Resolution cells (approx.)} & 425 (range) × 602 (cross-range) \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/test1/ina226_power.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/test1/ina226_current.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/test1/ina226_voltage.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/test1/xpe.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/test1/kernel_tile_layout.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/test1/kernel_tile_dataflow.png}
